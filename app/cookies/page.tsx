...
export const metadata = {
  title: 'Cookie Policy | FloatChat',
  description: 'FloatChat Cookie Policy — the trackers we use, the third parties involved, their durations, and how to manage your preferences.',
  alternates: { canonical: 'https://floatchat.com/cookies' },
}
        ...
        <section className="pb-16 lg:pb-24 bg-white">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-none">
              ...
              <iframe
                ref={iframeRef}
                src="https://www.iubenda.com/privacy-policy/32586379/cookie-policy"
                title="FloatChat Cookie Policy"
                className="block w-full"
                style={{ height: "9000px", border: 0, background: "transparent" }}
                loading="lazy"
                scrolling="no"
              />
