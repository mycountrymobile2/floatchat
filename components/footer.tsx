...
const footerLinks = {
  Platform: [
    ...
    { name: "Voice AI Agents", href: "/voice-ai-agents" },
    ...
    { name: "Virtual Numbers", href: "/numbers/did" },
    { name: "Integrations", href: "/integrations" },
    { name: "Security", href: "/platform/security" },
    { name: "Pricing", href: "/pricing" },
  ],
  Channels: [
    { name: "WhatsApp", href: "/channels/whatsapp" },
    { name: "WhatsApp Broadcasting", href: "/channels/whatsapp-broadcasting" },
    { name: "RCS", href: "/channels/rcs" },
    { name: "RCS Broadcasting", href: "/channels/rcs-broadcasting" },
    { name: "SMS Broadcasting", href: "/channels/sms-broadcasting" },
    { name: "Voice", href: "/channels/voice" },
    { name: "Instagram", href: "/channels/instagram" },
    { name: "Messenger", href: "/channels/messenger" },
    { name: "Web Chat", href: "/channels/web-chat" },
    { name: "Social", href: "/channels/social" },
  ],
  Industries: [
    { name: "Retail & eCommerce", href: "/industry/retail" },
    { name: "Travel & Hospitality", href: "/industry/travel-and-hospitality" },
    ...
    { name: "Mortgage", href: "/industry/mortgage" },
    { name: "Telecom", href: "/industry/telecom" },
    { name: "Real Estate", href: "/industry/real-estate" },
  ],
  Compare: [
    { name: "All comparisons", href: "/compare" },
    { name: "vs Haptik", href: "/compare/haptik" },
    { name: "vs Twilio", href: "/compare/twilio" },
    { name: "vs Twixor", href: "/compare/twixor" },
    { name: "vs Infobip", href: "/compare/infobip" },
    { name: "Why FloatChat", href: "/why-floatchat" },
