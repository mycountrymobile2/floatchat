...
const routes = [
  ...
  "/compare",
  "/compare/haptik", "/compare/twilio", "/compare/twixor", "/compare/infobip",
  ...
  "/platform", "/platform/security", "/why-floatchat", "/partnerships",
  "/services/ai-consulting", "/voice-ai-agents", "/numbers/did",
  "/channels/whatsapp", "/channels/whatsapp-broadcasting", "/channels/rcs",
  "/channels/rcs-broadcasting", "/channels/sms-broadcasting", "/channels/voice",
  "/channels/instagram", "/channels/messenger", "/channels/web-chat", "/channels/social",
  "/industry/retail", "/industry/travel-and-hospitality", "/industry/fintech",
  "/industry/education", "/industry/media-entertainment", "/industry/healthcare",
  "/industry/insurance", "/industry/mortgage", "/industry/telecom", "/industry/real-estate",
